...
The dataset is very popular and can be downloaded from different sources, such as Kaggle or many university webpages. This notebook took it from the following link: https://github.com/jbryer/CompStats/raw/master/Data/titanic3.csv
